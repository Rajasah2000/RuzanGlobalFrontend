...
const ArcticRefrigeration = () => {
  ...
  const handleStarClick = (value) => {
    ...
    if (value >= 4) {
      window.location.href = "https://g.page/r/CVk1_34AlGXsEBM/review";
    }
  };
  ...
  const handleSubmit = (event) => {
    ...
    const data = {
      ...
      registeredBy: "674bd869dba38be9a71e5bec",
    };
    ...
    fetch("https://api.ruzanglobal.com/api/user/register", {
      ...
      .then((responseData) => {
        ...
        if (responseData?.status) {
          ...
          console.log("Error to add review", responseData);
        }
      });
  };
...
export default ArcticRefrigeration;
